	 ...
	 public void backgroundServiceMethod() throws UnirestException
	 {
	     ...
	     while (it.hasNext()) 
	     {
		     ...
		     { 	 
			     ...
			     {
			    	 //team 100 a gagné
			    	 List<listBetor> betors = listBetor.getList(jsonResponse.get("gameId").getAsString(), "100");
			     ...
			     {
			    	 //team 200 a gagné
			    	 List<listBetor> betors = listBetor.getList(jsonResponse.get("gameId").getAsString(), "200");
			    	 NotifyUser notif = new NotifyUser(betors, jsonResponse.get("gameId").getAsString());
			    	 notif.notif();
			     }
